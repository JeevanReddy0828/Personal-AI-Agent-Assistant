...
_NO_TOOL_CLAIMS = (
    ...
    "The same holds for anything that changes this machine - arranging windows, opening an "
    "app, setting a reminder, sending mail, downloading a file. Those run on a tool's own "
    ...
    "nothing whatsoever had happened. Say what to ask for instead, such as 'put WhatsApp on "
    "the left and Chrome on the right'. "
