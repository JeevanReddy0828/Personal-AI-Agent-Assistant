...
- Consistent reveal: chat answers stream token-by-token, and instant local command results animate in with a typewriter pass so everything feels alive (skipped for very long output; cancels on Stop).
